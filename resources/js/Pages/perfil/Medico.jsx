...
import { LiaUserNurseSolid, LiaKeySolid } from "react-icons/lia";
            ...
            <div>
                ...
                <div className="bg-white p-4">
                    <div className="text-lg font-medium flex items-center gap-2 border-b pb-2 mb-4">
                        <LiaUserNurseSolid className="text-cyan-400 text-4xl" />
                        {medico ? "Editar Perfil do Médico" : "Completar Perfil do Médico"}
                    </div>
                    ...
                    <form onSubmit={submit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        {/* Ordem */}
                        <div>
                            <label className="font-semibold text-sm text-gray-600 my-2">Nº Ordem</label>
                            <input
                                type="text"
                            ...
                            />
                            {errors.ordem && <span className="text-red-600 text-xs">{errors.ordem}</span>}
                        </div>
                        ...
                        {/* Especialidade */}
                        <div>
                            <label className="font-semibold text-sm text-gray-600 my-2">Especialidade</label>
                            <select
                                className="w-full border rounded p-2"
                            ...
                            {errors.especialidade_id && (
                                <span className="text-red-600 text-xs">{errors.especialidade_id}</span>
                            )}
                        </div>
